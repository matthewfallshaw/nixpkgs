...
inoremap <buffer> ;;s include <stdlib.scad><CR><CR>$fn=0;<CR>$fa=12;<CR>$fs=2;<CR><CR>
  \// $fn=16;<CR>$fn=32;<CR>$fn=64;<CR><ESC>cc<CR>// BIGNUM=100;<CR><ESC>cc<CR><CR>

setlocal commentstring=//\ %s

autocmd BufRead,BufNewFile *.escad set filetype=openscad
